...
for expected_env in $ubiquity_envs $ubiquity_db_envs $ubiquity_provisioner_envs $ubiquity_flex_envs $ubiquity_flex_sidecar_envs $ubiquity_helm_envs; do
...
echo $out_UBIQUITY_K8S_HELM_IMAGE_MULTIARCH
