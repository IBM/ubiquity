...
type FakeStorageClient struct {
	...
	GetCapabilitiesStub        func(capabilitiesRequest resources.GetCapabilitiesRequest) (resources.Capabilities, error)
	...
	getCapabilitiesReturns struct {
		result1 resources.Capabilities
		result2 error
	}
...
func (fake *FakeStorageClient) GetCapabilities(capabilitiesRequest resources.GetCapabilitiesRequest) (resources.Capabilities, error) {
	...
	fake.recordInvocation("GetCapabilities", []interface{}{capabilitiesRequest})
	fake.getCapabilitiesMutex.Unlock()
	if fake.GetCapabilitiesStub != nil {
		return fake.GetCapabilitiesStub(capabilitiesRequest)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeStorageClient) GetCapabilitiesCallCount() int {
	fake.getCapabilitiesMutex.RLock()
	defer fake.getCapabilitiesMutex.RUnlock()
	return len(fake.getCapabilitiesArgsForCall)
}

func (fake *FakeStorageClient) GetCapabilitiesArgsForCall(i int) resources.GetCapabilitiesRequest {
	fake.getCapabilitiesMutex.RLock()
	defer fake.getCapabilitiesMutex.RUnlock()
	return fake.getCapabilitiesArgsForCall[i].capabilitiesRequest
}

func (fake *FakeStorageClient) GetCapabilitiesReturns(result1 resources.Capabilities, result2 error) {
...
func (fake *FakeStorageClient) GetCapabilitiesReturnsOnCall(i int, result1 resources.Capabilities, result2 error) {
	fake.GetCapabilitiesStub = nil
