...
type FakeScbeRestClient struct {
	...
	GetVolumesByVolNameStub        func(volName string) ([]scbe.ScbeVolumeInfo, error)
	getVolumesByVolNameMutex       sync.RWMutex
	getVolumesByVolNameArgsForCall []struct {
		volName string
	}
	getVolumesByVolNameReturns struct {
		result1 []scbe.ScbeVolumeInfo
		result2 error
	}
	getVolumesByVolNameReturnsOnCall map[int]struct {
		result1 []scbe.ScbeVolumeInfo
		result2 error
	}
...
func (fake *FakeScbeRestClient) GetVolumesByVolName(volName string) ([]scbe.ScbeVolumeInfo, error) {
	fake.getVolumesByVolNameMutex.Lock()
	ret, specificReturn := fake.getVolumesByVolNameReturnsOnCall[len(fake.getVolumesByVolNameArgsForCall)]
	fake.getVolumesByVolNameArgsForCall = append(fake.getVolumesByVolNameArgsForCall, struct {
		volName string
	}{volName})
	fake.recordInvocation("GetVolumesByVolName", []interface{}{volName})
	fake.getVolumesByVolNameMutex.Unlock()
	if fake.GetVolumesByVolNameStub != nil {
		return fake.GetVolumesByVolNameStub(volName)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.getVolumesByVolNameReturns.result1, fake.getVolumesByVolNameReturns.result2
}

func (fake *FakeScbeRestClient) GetVolumesByVolNameCallCount() int {
	fake.getVolumesByVolNameMutex.RLock()
	defer fake.getVolumesByVolNameMutex.RUnlock()
	return len(fake.getVolumesByVolNameArgsForCall)
}

func (fake *FakeScbeRestClient) GetVolumesByVolNameArgsForCall(i int) string {
	fake.getVolumesByVolNameMutex.RLock()
	defer fake.getVolumesByVolNameMutex.RUnlock()
	return fake.getVolumesByVolNameArgsForCall[i].volName
}

func (fake *FakeScbeRestClient) GetVolumesByVolNameReturns(result1 []scbe.ScbeVolumeInfo, result2 error) {
	fake.GetVolumesByVolNameStub = nil
	fake.getVolumesByVolNameReturns = struct {
		result1 []scbe.ScbeVolumeInfo
		result2 error
	}{result1, result2}
}

func (fake *FakeScbeRestClient) GetVolumesByVolNameReturnsOnCall(i int, result1 []scbe.ScbeVolumeInfo, result2 error) {
	fake.GetVolumesByVolNameStub = nil
	if fake.getVolumesByVolNameReturnsOnCall == nil {
		fake.getVolumesByVolNameReturnsOnCall = make(map[int]struct {
			result1 []scbe.ScbeVolumeInfo
			result2 error
		})
	}
	fake.getVolumesByVolNameReturnsOnCall[i] = struct {
		result1 []scbe.ScbeVolumeInfo
		result2 error
	}{result1, result2}
}
