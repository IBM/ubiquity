...
type FakeStorageBackend struct {
	...
	ListStub        func() ([]model.VolumeMetadata, error)
	...
	GetStub        func(name string) (volumeMetadata *model.VolumeMetadata, config *map[string]interface{}, err error)
...
func (fake *FakeStorageBackend) Create(name string, opts map[string]interface{}) error {
...
func (fake *FakeStorageBackend) CreateCallCount() int {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return len(fake.createArgsForCall)
}

func (fake *FakeStorageBackend) CreateArgsForCall(i int) (string, map[string]interface{}) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return fake.createArgsForCall[i].name, fake.createArgsForCall[i].opts
}

func (fake *FakeStorageBackend) CreateReturns(result1 error) {
	fake.CreateStub = nil
...
func (fake *FakeStorageBackend) Remove(name string) error {
...
func (fake *FakeStorageBackend) RemoveCallCount() int {
	fake.removeMutex.RLock()
	defer fake.removeMutex.RUnlock()
	return len(fake.removeArgsForCall)
}

func (fake *FakeStorageBackend) RemoveArgsForCall(i int) string {
	fake.removeMutex.RLock()
	defer fake.removeMutex.RUnlock()
	return fake.removeArgsForCall[i].name
}

func (fake *FakeStorageBackend) RemoveReturns(result1 error) {
	fake.RemoveStub = nil
...
func (fake *FakeStorageBackend) List() ([]model.VolumeMetadata, error) {
	fake.listMutex.Lock()
...
func (fake *FakeStorageBackend) ListCallCount() int {
	fake.listMutex.RLock()
	defer fake.listMutex.RUnlock()
	return len(fake.listArgsForCall)
}

func (fake *FakeStorageBackend) ListReturns(result1 []model.VolumeMetadata, result2 error) {
	fake.ListStub = nil
...
func (fake *FakeStorageBackend) Get(name string) (volumeMetadata *model.VolumeMetadata, config *map[string]interface{}, err error) {
	fake.getMutex.Lock()
...
func (fake *FakeStorageBackend) GetCallCount() int {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
	return len(fake.getArgsForCall)
}

func (fake *FakeStorageBackend) GetArgsForCall(i int) string {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
	return fake.getArgsForCall[i].name
}

func (fake *FakeStorageBackend) GetReturns(result1 *model.VolumeMetadata, result2 *map[string]interface{}, result3 error) {
	fake.GetStub = nil
...
func (fake *FakeStorageBackend) IsMounted() (bool, error) {
...
func (fake *FakeStorageBackend) IsMountedCallCount() int {
	fake.isMountedMutex.RLock()
	defer fake.isMountedMutex.RUnlock()
	return len(fake.isMountedArgsForCall)
}

func (fake *FakeStorageBackend) IsMountedReturns(result1 bool, result2 error) {
...
func (fake *FakeStorageBackend) Mount() error {
...
func (fake *FakeStorageBackend) MountCallCount() int {
	fake.mountMutex.RLock()
	defer fake.mountMutex.RUnlock()
	return len(fake.mountArgsForCall)
}

func (fake *FakeStorageBackend) MountReturns(result1 error) {
	fake.MountStub = nil
...
var _ core.StorageBackend = new(FakeStorageBackend)
